...
export default function EventPreview({ date, title, location, city, country }) {
  return (
    <div className="flex flex-col w-[335px] items-center gap-1 bg-hover p-12 rounded-xl shadow-lg hover:-translate-y-2 hover:shadow-xl hover:bg-hoverDark duration-300 cursor-pointer">

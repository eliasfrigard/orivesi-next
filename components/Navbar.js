...
export default function Navbar() {
  ...
  return (
    ...
    >
      <Link href="/">
        <div className="leading-4 cursor-pointer flex flex-col justify-center text-center w-1/5 text-secondary-500 hover:text-secondary-800 duration-150 mt-[-4px] tracking-wider">
          <p className="font-work  font-medium text-3xl text-accent-500">ORIVESI</p>
          <p className="font-work font-bold text-[21px] ">ALL STARS</p>
        </div>
      </Link>

...
export default function NewsPage({ event }) {
  return (
    <Layout>
      <div className='container flex my-16 flex-col items-start text-grey-500'>
        <div className=''>
        ...
        <div className='flex w-full flex-wrap gap-14 xl:gap-24 items-start'>
          ...
          {/* INFO CONTAINER */}
          <div className='flex flex-col flex-1 w-full text-xl p-9 gap-6 border-secondary-800 border-4 rounded-2xl shadow-lg'>
            ...
            <div className='flex flex-col gap-5 mt-2'>
              ...
              <div className='flex gap-3 items-center'>
                ...
                <Moment format='DD MMMM YYYY' locale='fi' className='capitalize text-2xl font-bold'>
                  {event.Date}
                </Moment>
              </div>
            </div>
            <div className='flex flex-col gap-4 font-medium text-grey-300'>
            ...
            <div className='flex gap-4 text-2xl text-secondary-800 items-center ml-2'>
              <BsFacebook className='text-[1.5rem] opacity-80 hover:opacity-100 hover:scale-125 hover:text-secondary-500 duration-150 active:scale-110 cursor-pointer' />
              ...
              <BsFillPinMapFill className='text-[1.5rem] opacity-80 hover:opacity-100 hover:scale-125 hover:text-secondary-500 duration-150 active:scale-110 cursor-pointer' />
            </div>
          </div>
        </div>
      </div>
